...
<div class="modal fade" id="siswa" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 type="modal-title" id="exampleModalLabel">Masukan Data</h5>
      </div>
      <div class="modal-body">
      ...
      <div class="row">
          ...
          <form action="input.php" method="POST">
                  ...
                  <button type="submit" class="btn btn-primary" data-dismiss="modal">Kirim</button>
...
if(isset($_POST['search']))
{
    ...
    $filter=$dbt->quote($_POST['search']);
    

    $name=$_POST['search'];

    $search=$dbt->prepare("select * from tim where id_Tim=? or id_siswa=? or nama_Tim=?");
    ...
    $data = $dbt->query("select * from tim");
      ...
      <tbody>
          <?php foreach ($data_siswa as $key):?>
              <tr>
                  ...
                  <!-- <td><a class="btn btn-danger" data-toggle="modal" data-target="#team" href="delete.php?id_tim=<?php echo $key['id_tim']; ?>"><i class="fas fa-user-times"></i></a> | <a class="btn btn-warning" href="edit.php?id_tim=<?php echo $key['id_tim']; ?>"><i class="fas fa-user-edit"></i></a></td> -->
              </tr>
  <?php endforeach; ?>
      </tbody>
  </table>
